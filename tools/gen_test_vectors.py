...
Generates, deterministically and from first principles:
  vectors/pipeline-vectors-v0.9.0.json
...
def build() -> "OrderedDict[str, bytes]":
    ...
    vectors["_meta"] = OrderedDict(
        [
            ...
            # Attribution travels with the artifact. A conformance vector set is
            # the normative definition of a behaviour, so whoever has to argue
            # about it later needs to know whose work it is without going to
            # another file for the answer.
            ("copyright", "2026 Denis Yermakou \u2014 authored for The AxonOS Project"),
            ("license_note", "Vectors are CC0-1.0 so any implementation may use "
                             "them; the pipeline itself is Apache-2.0 OR MIT. See NOTICE."),
...
// Authored for The AxonOS Project — https://axonos.org
