...
[![release](https://img.shields.io/badge/release-v0.9.0-6af6ff)](https://github.com/AxonOS-org/axonos-signal-pipeline/releases)
...
`axonos-pipeline-core` v0.9.0 — the **type contract, conformance surface,
...
[`vectors/pipeline-vectors-v0.9.0.json`](vectors/pipeline-vectors-v0.9.0.json)
